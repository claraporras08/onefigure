...
on(document, 'click', '.btnBorrar', e => {
    ...
    alertify.confirm("CONFIRMA QUE DESEA ELIMINAR EL USUARIO",
    function(){
        fetch(url+id, {
            method: 'DELETE'
        })
        ...
        alertify.success('EL USUARIO HA SIDO BORRADO')
    },
    function(){
        alertify.error('SE CANCELO EL BORRADO DEL USUARIO')
    })
})
...
on(document, 'click', '.btnEditar', e => {    
    ...
    const empresaForm = fila.children[4].innerHTML
...
formArticulo.addEventListener('submit', (e)=>{
    ...
    if(opcion=='editar'){    
        id.exampleModalLabel = "EDITAR USUARIO"
